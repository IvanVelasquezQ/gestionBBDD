...
--2.	Cuál es la variación de registros realizados del 2023 al 2022?
		--Solución 1
		declare @reg2022 float
		set @reg2022 = (select count(*) from grupo2.RegistrosElectricos
		where YEAR(grupo2.RegistrosElectricos.Fecha_Puesta_Servicio)=2022)
		
		declare @reg2023 float
		set @reg2023= (select count(*) from grupo2.RegistrosElectricos
		where YEAR(grupo2.RegistrosElectricos.Fecha_Puesta_Servicio)=2023)
		Print @reg2023/@reg2022-1
